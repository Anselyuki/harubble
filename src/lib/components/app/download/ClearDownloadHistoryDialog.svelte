<script lang="ts">
  ...
  const labels = $derived.by(() => {
    ...
    return {
      title: m.download_clear_history_dialog_title(),
      description: m.download_clear_history_dialog_description(),
      cancel: m.download_clear_history_dialog_cancel(),
      confirm: m.download_clear_history_dialog_confirm(),
    };
  });
